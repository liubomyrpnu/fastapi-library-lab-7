...
def get_optional_user(request: Request) -> str | None:
    """Намагається витягнути user_id з токена, але не кидає помилку якщо токена немає."""
...
async def get_books(
    ...
    return BookListResponse(items=books, limit=limit, offset=offset, total=len(books))
